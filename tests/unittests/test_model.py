...
def test_efficientnet_pretrained_parameter():
    ...
    assert isinstance(model_pretrained, MyEfficientNetModel), "Pretrained model is not an instance of MyEfficientNetModel"
    assert isinstance(model_not_pretrained, MyEfficientNetModel), "Non-pretrained model is not an instance of MyEfficientNetModel"