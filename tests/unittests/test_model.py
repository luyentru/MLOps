...
def test_efficientnet_model_init():
    ...
    assert model.base_model.classifier[0].out_features == 4, "EfficientNet does not create 4 output classes"
...
def test_efficientnet_forward_pass():
    ...
    assert output.shape == (1, 4), "EfficientNet does not create 4 output classes"
